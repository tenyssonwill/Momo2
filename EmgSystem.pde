...
class EmgManager implements IEmgManager {
  ...
  LibDelsysTrignoProportional myoProportional;

  EmgManager() throws DelsysTrignoNotDetectedError {
    myoProportional = new LibDelsysTrignoProportional(mainObject);
  }
  ...
  */
  ...
  void flushEmgData(long init_time, long end_time) {
    myoProportional.flushEmgData(init_time,end_time);
  }
  ...
  public ConcurrentLinkedQueue<Sample> pollAll() {
      return myoProportional.pollAll();
  }
}
