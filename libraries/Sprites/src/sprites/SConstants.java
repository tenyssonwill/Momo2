...
public interface SConstants {
	...
	public final static int DRAG 			= MouseEvent.DRAG;
	public final static int CLICK	 		= MouseEvent.CLICK;
	public final static int PRESS	 		= MouseEvent.PRESS;
	public final static int RELEASE 		= MouseEvent.RELEASE;
